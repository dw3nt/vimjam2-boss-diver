...
func initCompetitorData() -> void:
	...
	competitorTotalScore.text = str("%.1f" % ChallengerTracker.getInterviewTotalScore(ChallengerTracker.currentChallengerKey, "competitor"))
...
func initPlayerData() -> void:
	...
	playerTotalScore.text = str("%.1f" % ChallengerTracker.getInterviewTotalScore(ChallengerTracker.currentChallengerKey, "player"))
